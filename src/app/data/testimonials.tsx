const testimonials = [
  {
    testimonial: `Carrie goes above and beyond, I believe she will excel in any role
  ...
  {
    testimonial: `Whatever you are trying to move through, you definitely want Carrie in
  ...
  {
    testimonial: `Working with Carrie has been truly transformative. From our very first
  ...
  {
    testimonial: `Carrie holds space like a mirror, calm and deeply present. In our
  ...
  {
    testimonial: `Having Carrie as a supportive presence in my life has been invaluable
